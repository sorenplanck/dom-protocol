 ...
 * instead if you have the choice (see dominterop_secp_v0_10_0_ecdsa_signature_parse_der and
 * dominterop_secp_v0_10_0_ecdsa_signature_parse_compact).
 *
 ...
 */
int dominterop_secp_v0_10_0_ecdsa_signature_parse_der_lax(
