...
typedef struct dominterop_secp_v0_10_0_bppp_generators dominterop_secp_v0_10_0_bppp_generators;
 ...
 */
SECP256K1_API dominterop_secp_v0_10_0_bppp_generators *dominterop_secp_v0_10_0_bppp_generators_create(
 ...
 *  Args:      ctx: pointer to a context object
 *  In:       data: data that came from `dominterop_secp_v0_10_0_bppp_generators_serialize`
 *        data_len: the length of the `data` buffer
 */
SECP256K1_API dominterop_secp_v0_10_0_bppp_generators *dominterop_secp_v0_10_0_bppp_generators_parse(
    const dominterop_secp_v0_10_0_context *ctx,
 ...
 */
SECP256K1_API int dominterop_secp_v0_10_0_bppp_generators_serialize(
    const dominterop_secp_v0_10_0_context *ctx,
    const dominterop_secp_v0_10_0_bppp_generators *gen,
    unsigned char *data,
    size_t *data_len
 ...
 */
SECP256K1_API void dominterop_secp_v0_10_0_bppp_generators_destroy(
    const dominterop_secp_v0_10_0_context *ctx,
    dominterop_secp_v0_10_0_bppp_generators *gen
) SECP256K1_ARG_NONNULL(1);
