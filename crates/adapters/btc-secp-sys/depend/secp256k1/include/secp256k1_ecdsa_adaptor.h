 ...
 *
 *  Same as dominterop_secp_v0_10_0_nonce_function_hardened with the exception of using the
 ...
 */
typedef int (*dominterop_secp_v0_10_0_nonce_function_hardened_ecdsa_adaptor)(
 ...
 */
SECP256K1_API const dominterop_secp_v0_10_0_nonce_function_hardened_ecdsa_adaptor dominterop_secp_v0_10_0_nonce_function_ecdsa_adaptor;
 ...
 *                         dominterop_secp_v0_10_0_nonce_function_ecdsa_adaptor is used
 *                  ndata: pointer to arbitrary data used by the nonce generation
 *                         function (can be NULL). If it is non-NULL and
 *                         dominterop_secp_v0_10_0_nonce_function_ecdsa_adaptor is used, then
 *                         ndata must be a pointer to 32-byte auxiliary randomness
 *                         as per BIP-340.
 */
SECP256K1_API int dominterop_secp_v0_10_0_ecdsa_adaptor_encrypt(
    const dominterop_secp_v0_10_0_context *ctx,
    unsigned char *adaptor_sig162,
    unsigned char *seckey32,
    const dominterop_secp_v0_10_0_pubkey *enckey,
    const unsigned char *msg32,
    dominterop_secp_v0_10_0_nonce_function_hardened_ecdsa_adaptor noncefp,
    void *ndata
 ...
 */
SECP256K1_API int dominterop_secp_v0_10_0_ecdsa_adaptor_verify(
    const dominterop_secp_v0_10_0_context *ctx,
 ...
 */
SECP256K1_API int dominterop_secp_v0_10_0_ecdsa_adaptor_decrypt(
    const dominterop_secp_v0_10_0_context *ctx,
 ...
 *                 enckey: pointer to the adaptor encryption public key
 */
SECP256K1_API int dominterop_secp_v0_10_0_ecdsa_adaptor_recover(
    const dominterop_secp_v0_10_0_context *ctx,
