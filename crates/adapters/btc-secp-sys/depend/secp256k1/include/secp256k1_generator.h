 ...
 *  comparison, use dominterop_secp_v0_10_0_generator_serialize and dominterop_secp_v0_10_0_generator_parse.
 */
typedef struct {
 ...
 */
SECP256K1_API const dominterop_secp_v0_10_0_generator *dominterop_secp_v0_10_0_generator_h;
 ...
 */
SECP256K1_API SECP256K1_WARN_UNUSED_RESULT int dominterop_secp_v0_10_0_generator_parse(
 ...
 */
SECP256K1_API int dominterop_secp_v0_10_0_generator_serialize(
    const dominterop_secp_v0_10_0_context *ctx,
    unsigned char *output,
    const dominterop_secp_v0_10_0_generator *gen
) SECP256K1_ARG_NONNULL(1) SECP256K1_ARG_NONNULL(2) SECP256K1_ARG_NONNULL(3);
 ...
 */
SECP256K1_API SECP256K1_WARN_UNUSED_RESULT int dominterop_secp_v0_10_0_generator_generate(
    const dominterop_secp_v0_10_0_context *ctx,
    dominterop_secp_v0_10_0_generator *gen,
 ...
 *
 *  The result is equivalent to first calling dominterop_secp_v0_10_0_generator_generate,
 *  converting the result to a public key, calling dominterop_secp_v0_10_0_ec_pubkey_tweak_add,
 *  and then converting back to generator form.
 */
SECP256K1_API SECP256K1_WARN_UNUSED_RESULT int dominterop_secp_v0_10_0_generator_generate_blinded(
    const dominterop_secp_v0_10_0_context *ctx,
    dominterop_secp_v0_10_0_generator *gen,
    const unsigned char *seed32,
 ...
 *  however guaranteed to be 64 bytes in size, and can be safely copied/moved.
 *  If you need to convert to a format suitable for storage, transmission, or
 *  comparison, use dominterop_secp_v0_10_0_pedersen_commitment_serialize and
 *  dominterop_secp_v0_10_0_pedersen_commitment_parse.
 */
typedef struct {
    unsigned char data[64];
} dominterop_secp_v0_10_0_pedersen_commitment;
 ...
 */
SECP256K1_API SECP256K1_WARN_UNUSED_RESULT int dominterop_secp_v0_10_0_pedersen_commitment_parse(
    const dominterop_secp_v0_10_0_context *ctx,
 ...
 *  Args:   ctx:        pointer to a context object
 *  Out:    output:     pointer to a 33-byte byte array
 *  In:     commit:     pointer to a dominterop_secp_v0_10_0_pedersen_commitment containing an
 *                      initialized commitment
 */
SECP256K1_API int dominterop_secp_v0_10_0_pedersen_commitment_serialize(
    const dominterop_secp_v0_10_0_context *ctx,
    unsigned char *output,
    const dominterop_secp_v0_10_0_pedersen_commitment *commit
) SECP256K1_ARG_NONNULL(1) SECP256K1_ARG_NONNULL(2) SECP256K1_ARG_NONNULL(3);
 ...
 */
SECP256K1_API SECP256K1_WARN_UNUSED_RESULT int dominterop_secp_v0_10_0_pedersen_commit(
  const dominterop_secp_v0_10_0_context *ctx,
  dominterop_secp_v0_10_0_pedersen_commitment *commit,
 ...
 */
SECP256K1_API SECP256K1_WARN_UNUSED_RESULT int dominterop_secp_v0_10_0_pedersen_blind_sum(
  const dominterop_secp_v0_10_0_context *ctx,
 ...
 *
 */
SECP256K1_API SECP256K1_WARN_UNUSED_RESULT int dominterop_secp_v0_10_0_pedersen_verify_tally(
  const dominterop_secp_v0_10_0_context *ctx,
  const dominterop_secp_v0_10_0_pedersen_commitment * const *commits,
  size_t pcnt,
  const dominterop_secp_v0_10_0_pedersen_commitment * const *ncommits,
  size_t ncnt
 ...
 */
SECP256K1_API SECP256K1_WARN_UNUSED_RESULT int dominterop_secp_v0_10_0_pedersen_blind_generator_blind_sum(
  const dominterop_secp_v0_10_0_context *ctx,
