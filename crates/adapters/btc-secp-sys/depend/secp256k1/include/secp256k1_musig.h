...
} dominterop_secp_v0_10_0_musig_keyagg_cache;
...
} dominterop_secp_v0_10_0_musig_secnonce;
...
typedef struct {
    unsigned char data[132];
} dominterop_secp_v0_10_0_musig_pubnonce;
...
typedef struct {
    unsigned char data[132];
} dominterop_secp_v0_10_0_musig_aggnonce;
...
} dominterop_secp_v0_10_0_musig_session;
...
} dominterop_secp_v0_10_0_musig_partial_sig;
 ...
 */
SECP256K1_API int dominterop_secp_v0_10_0_musig_pubnonce_parse(
    const dominterop_secp_v0_10_0_context *ctx,
    dominterop_secp_v0_10_0_musig_pubnonce *nonce,
 ...
 */
SECP256K1_API int dominterop_secp_v0_10_0_musig_pubnonce_serialize(
    const dominterop_secp_v0_10_0_context *ctx,
    unsigned char *out66,
    const dominterop_secp_v0_10_0_musig_pubnonce *nonce
) SECP256K1_ARG_NONNULL(1) SECP256K1_ARG_NONNULL(2) SECP256K1_ARG_NONNULL(3);
 ...
 *  In:     in66: pointer to the 66-byte nonce to be parsed
 */
SECP256K1_API int dominterop_secp_v0_10_0_musig_aggnonce_parse(
    const dominterop_secp_v0_10_0_context *ctx,
    dominterop_secp_v0_10_0_musig_aggnonce *nonce,
    const unsigned char *in66
) SECP256K1_ARG_NONNULL(1) SECP256K1_ARG_NONNULL(2) SECP256K1_ARG_NONNULL(3);
 ...
 *  In:    nonce: pointer to the nonce
 */
SECP256K1_API int dominterop_secp_v0_10_0_musig_aggnonce_serialize(
    const dominterop_secp_v0_10_0_context *ctx,
    unsigned char *out66,
    const dominterop_secp_v0_10_0_musig_aggnonce *nonce
) SECP256K1_ARG_NONNULL(1) SECP256K1_ARG_NONNULL(2) SECP256K1_ARG_NONNULL(3);
 ...
 */
SECP256K1_API int dominterop_secp_v0_10_0_musig_partial_sig_serialize(
    const dominterop_secp_v0_10_0_context *ctx,
    unsigned char *out32,
    const dominterop_secp_v0_10_0_musig_partial_sig *sig
) SECP256K1_ARG_NONNULL(1) SECP256K1_ARG_NONNULL(2) SECP256K1_ARG_NONNULL(3);
 ...
 */
SECP256K1_API int dominterop_secp_v0_10_0_musig_partial_sig_parse(
    const dominterop_secp_v0_10_0_context *ctx,
    dominterop_secp_v0_10_0_musig_partial_sig *sig,
 ...
 *
 *  Before aggregating, the pubkeys can be sorted with `dominterop_secp_v0_10_0_pubkey_sort`
 ...
 */
SECP256K1_API int dominterop_secp_v0_10_0_musig_pubkey_agg(
    const dominterop_secp_v0_10_0_context *ctx,
    ...
    const dominterop_secp_v0_10_0_pubkey * const *pubkeys,
    size_t n_pubkeys
 ...
 *                    `musig_pubkey_agg`
 */
SECP256K1_API SECP256K1_WARN_UNUSED_RESULT int dominterop_secp_v0_10_0_musig_pubkey_get(
    const dominterop_secp_v0_10_0_context *ctx,
    dominterop_secp_v0_10_0_pubkey *agg_pk,
    const dominterop_secp_v0_10_0_musig_keyagg_cache *keyagg_cache
) SECP256K1_ARG_NONNULL(1) SECP256K1_ARG_NONNULL(2) SECP256K1_ARG_NONNULL(3);
 ...
 *
 *  The tweaking method is the same as `dominterop_secp_v0_10_0_ec_pubkey_tweak_add`. So after
 *  the following pseudocode buf and buf2 have identical contents (absent
 *  earlier failures).
 *
 *  dominterop_secp_v0_10_0_musig_pubkey_agg(..., keyagg_cache, pubkeys, ...)
 *  dominterop_secp_v0_10_0_musig_pubkey_get(..., agg_pk, keyagg_cache)
 *  dominterop_secp_v0_10_0_musig_pubkey_ec_tweak_add(..., output_pk, tweak32, keyagg_cache)
 *  dominterop_secp_v0_10_0_ec_pubkey_serialize(..., buf, output_pk)
 *  dominterop_secp_v0_10_0_ec_pubkey_tweak_add(..., agg_pk, tweak32)
 *  dominterop_secp_v0_10_0_ec_pubkey_serialize(..., buf2, agg_pk)
 *
 *  This function is required if you want to _sign_ for a tweaked aggregate key.
 *  On the other hand, if you are only computing a public key, but not intending
 *  to create a signature for it, you can just use
 *  `dominterop_secp_v0_10_0_ec_pubkey_tweak_add`.
 *
 ...
 *                        according to `dominterop_secp_v0_10_0_ec_seckey_verify`, this function
 *                        returns 0. For uniformly random 32-byte arrays the
 *                        chance of being invalid is negligible (around 1 in
 *                        2^128).
 */
SECP256K1_API SECP256K1_WARN_UNUSED_RESULT int dominterop_secp_v0_10_0_musig_pubkey_ec_tweak_add(
    const dominterop_secp_v0_10_0_context *ctx,
    dominterop_secp_v0_10_0_pubkey *output_pubkey,
    dominterop_secp_v0_10_0_musig_keyagg_cache *keyagg_cache,
 ...
 *  Taproot outputs.
 *
 *  The tweaking method is the same as `dominterop_secp_v0_10_0_xonly_pubkey_tweak_add`. So in
 *  the following pseudocode xonly_pubkey_tweak_add_check (absent earlier
 *  failures) returns 1.
 *
 *  dominterop_secp_v0_10_0_musig_pubkey_agg(..., agg_pk, keyagg_cache, pubkeys, ...)
 *  dominterop_secp_v0_10_0_musig_pubkey_xonly_tweak_add(..., output_pk, tweak32, keyagg_cache)
 *  dominterop_secp_v0_10_0_xonly_pubkey_serialize(..., buf, output_pk)
 *  dominterop_secp_v0_10_0_xonly_pubkey_tweak_add_check(..., buf, ..., agg_pk, tweak32)
 *
 *  This function is required if you want to _sign_ for a tweaked aggregate key.
 *  On the other hand, if you are only computing a public key, but not intending
 *  to create a signature for it, you can just use
 *  `dominterop_secp_v0_10_0_xonly_pubkey_tweak_add`.
 *
 *  Returns: 0 if the arguments are invalid or the resulting public key would be
 *           invalid (only when the tweak is the negation of the corresponding
 *           secret key). 1 otherwise.
 ...
 *                        2^128).
 */
SECP256K1_API SECP256K1_WARN_UNUSED_RESULT int dominterop_secp_v0_10_0_musig_pubkey_xonly_tweak_add(
    const dominterop_secp_v0_10_0_context *ctx,
    dominterop_secp_v0_10_0_pubkey *output_pubkey,
    dominterop_secp_v0_10_0_musig_keyagg_cache *keyagg_cache,
    const unsigned char *tweak32
 ...
 *                     call to dominterop_secp_v0_10_0_musig_nonce_gen and must be uniformly random
 ...
 */
SECP256K1_API int dominterop_secp_v0_10_0_musig_nonce_gen(
    const dominterop_secp_v0_10_0_context *ctx,
 ...
 *                       greater than 0.
 */
SECP256K1_API int dominterop_secp_v0_10_0_musig_nonce_agg(
    const dominterop_secp_v0_10_0_context *ctx,
    dominterop_secp_v0_10_0_musig_aggnonce  *aggnonce,
    const dominterop_secp_v0_10_0_musig_pubnonce * const *pubnonces,
    size_t n_pubnonces
) SECP256K1_ARG_NONNULL(1) SECP256K1_ARG_NONNULL(2) SECP256K1_ARG_NONNULL(3);
 ...
 */
SECP256K1_API SECP256K1_WARN_UNUSED_RESULT int dominterop_secp_v0_10_0_musig_nonce_process(
    const dominterop_secp_v0_10_0_context *ctx,
    dominterop_secp_v0_10_0_musig_session *session,
    const dominterop_secp_v0_10_0_musig_aggnonce  *aggnonce,
    const unsigned char *msg32,
    const dominterop_secp_v0_10_0_musig_keyagg_cache *keyagg_cache,
    const dominterop_secp_v0_10_0_pubkey *adaptor
 ...
 *  signature with `dominterop_secp_v0_10_0_musig_partial_sig_verify` to prevent random or
 ...
 *                     musig_nonce_process
 */
SECP256K1_API int dominterop_secp_v0_10_0_musig_partial_sign(
    const dominterop_secp_v0_10_0_context *ctx,
    dominterop_secp_v0_10_0_musig_partial_sig *partial_sig,
    dominterop_secp_v0_10_0_musig_secnonce *secnonce,
    const dominterop_secp_v0_10_0_keypair *keypair,
    const dominterop_secp_v0_10_0_musig_keyagg_cache *keyagg_cache,
    const dominterop_secp_v0_10_0_musig_session *session
 ...
 *                    `musig_nonce_process`
 */
SECP256K1_API SECP256K1_WARN_UNUSED_RESULT int dominterop_secp_v0_10_0_musig_partial_sig_verify(
    const dominterop_secp_v0_10_0_context *ctx,
    const dominterop_secp_v0_10_0_musig_partial_sig *partial_sig,
    const dominterop_secp_v0_10_0_musig_pubnonce *pubnonce,
    const dominterop_secp_v0_10_0_pubkey *pubkey,
    const dominterop_secp_v0_10_0_musig_keyagg_cache *keyagg_cache,
    const dominterop_secp_v0_10_0_musig_session *session
) SECP256K1_ARG_NONNULL(1) SECP256K1_ARG_NONNULL(2) SECP256K1_ARG_NONNULL(3) SECP256K1_ARG_NONNULL(4) SECP256K1_ARG_NONNULL(5) SECP256K1_ARG_NONNULL(6);
 ...
 *                     greater than 0.
 */
SECP256K1_API int dominterop_secp_v0_10_0_musig_partial_sig_agg(
    const dominterop_secp_v0_10_0_context *ctx,
    unsigned char *sig64,
    const dominterop_secp_v0_10_0_musig_session *session,
    const dominterop_secp_v0_10_0_musig_partial_sig * const *partial_sigs,
    size_t n_sigs
 ...
 *                     musig_nonce_process
 */
SECP256K1_API int dominterop_secp_v0_10_0_musig_nonce_parity(
    const dominterop_secp_v0_10_0_context *ctx,
    int *nonce_parity,
    const dominterop_secp_v0_10_0_musig_session *session
) SECP256K1_ARG_NONNULL(1) SECP256K1_ARG_NONNULL(2) SECP256K1_ARG_NONNULL(3);
 ...
 */
SECP256K1_API SECP256K1_WARN_UNUSED_RESULT int dominterop_secp_v0_10_0_musig_adapt(
    const dominterop_secp_v0_10_0_context *ctx,
    unsigned char *sig64,
 ...
 */
SECP256K1_API SECP256K1_WARN_UNUSED_RESULT int dominterop_secp_v0_10_0_musig_extract_adaptor(
    const dominterop_secp_v0_10_0_context *ctx,
