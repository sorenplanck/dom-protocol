 ...
 */
SECP256K1_API SECP256K1_WARN_UNUSED_RESULT int dominterop_secp_v0_10_0_rangeproof_verify(
 ...
 */
SECP256K1_API SECP256K1_WARN_UNUSED_RESULT int dominterop_secp_v0_10_0_rangeproof_rewind(
  const dominterop_secp_v0_10_0_context *ctx,
 ...
 *
 */
SECP256K1_API SECP256K1_WARN_UNUSED_RESULT int dominterop_secp_v0_10_0_rangeproof_sign(
  const dominterop_secp_v0_10_0_context *ctx,
  unsigned char *proof,
  size_t *plen,
  uint64_t min_value,
 ...
 *        max_value: pointer to an unsigned int64 which will be updated with the maximum value that commit could have. (cannot be NULL)
 */
SECP256K1_API SECP256K1_WARN_UNUSED_RESULT int dominterop_secp_v0_10_0_rangeproof_info(
  const dominterop_secp_v0_10_0_context *ctx,
  int *exp,
  int *mantissa,
  uint64_t *min_value,
 ...
 * the `exp` parameter to `dominterop_secp_v0_10_0_rangeproof_sign` is set such that
 ...
 */
SECP256K1_API SECP256K1_WARN_UNUSED_RESULT size_t dominterop_secp_v0_10_0_rangeproof_max_size(
  const dominterop_secp_v0_10_0_context *ctx,
  uint64_t max_value,
  int min_bits
