 ...
 */
SECP256K1_API int dominterop_secp_v0_10_0_schnorrsig_inc_aggregate(
    const dominterop_secp_v0_10_0_context *ctx,
    unsigned char *aggsig,
    size_t *aggsig_len,
    const dominterop_secp_v0_10_0_xonly_pubkey* all_pubkeys,
 ...
 */
SECP256K1_API int dominterop_secp_v0_10_0_schnorrsig_aggregate(
    const dominterop_secp_v0_10_0_context *ctx,
    unsigned char *aggsig,
    size_t *aggsig_len,
    const dominterop_secp_v0_10_0_xonly_pubkey *pubkeys,
 ...
 */
SECP256K1_API SECP256K1_WARN_UNUSED_RESULT int dominterop_secp_v0_10_0_schnorrsig_aggverify(
    const dominterop_secp_v0_10_0_context *ctx,
    const dominterop_secp_v0_10_0_xonly_pubkey *pubkeys,
    const unsigned char *msgs32,
    size_t n,
