 ...
 *
 *  To obtain these properties, instead use dominterop_secp_v0_10_0_surjectionproof_parse
 *  and dominterop_secp_v0_10_0_surjectionproof_serialize to encode/decode proofs into a
 *  well-defined format.
 *
...
typedef struct {
#ifdef VERIFY
    /** Mark whether this proof has gone through `dominterop_secp_v0_10_0_surjectionproof_initialize` */
    int initialized;
#endif
...
} dominterop_secp_v0_10_0_surjectionproof;
 ...
 */
SECP256K1_API int dominterop_secp_v0_10_0_surjectionproof_parse(
 ...
 *
 *  See dominterop_secp_v0_10_0_surjectionproof_parse for details about the encoding.
 */
SECP256K1_API int dominterop_secp_v0_10_0_surjectionproof_serialize(
  const dominterop_secp_v0_10_0_context *ctx,
  unsigned char *output,
  size_t *outputlen,
  const dominterop_secp_v0_10_0_surjectionproof *proof
...
} dominterop_secp_v0_10_0_fixed_asset_tag;
 ...
 */
SECP256K1_API size_t dominterop_secp_v0_10_0_surjectionproof_n_total_inputs(
  const dominterop_secp_v0_10_0_context *ctx,
  const dominterop_secp_v0_10_0_surjectionproof *proof
 ...
 *     proof: pointer to a proof object
 */
SECP256K1_API size_t dominterop_secp_v0_10_0_surjectionproof_n_used_inputs(
  const dominterop_secp_v0_10_0_context *ctx,
  const dominterop_secp_v0_10_0_surjectionproof *proof
) SECP256K1_ARG_NONNULL(1) SECP256K1_ARG_NONNULL(2);
 ...
 *     proof: pointer to a proof object
 */
SECP256K1_API size_t dominterop_secp_v0_10_0_surjectionproof_serialized_size(
  const dominterop_secp_v0_10_0_context *ctx,
  const dominterop_secp_v0_10_0_surjectionproof *proof
) SECP256K1_ARG_NONNULL(1) SECP256K1_ARG_NONNULL(2);

/** Surjection proof initialization function; decides on inputs to use
 *  To be used to initialize stack-allocated dominterop_secp_v0_10_0_surjectionproof struct
 ...
 */
SECP256K1_API SECP256K1_WARN_UNUSED_RESULT int dominterop_secp_v0_10_0_surjectionproof_initialize(
  const dominterop_secp_v0_10_0_context *ctx,
  dominterop_secp_v0_10_0_surjectionproof *proof,
  size_t *input_index,
  const dominterop_secp_v0_10_0_fixed_asset_tag *fixed_input_tags,
  const size_t n_input_tags,
  const size_t n_input_tags_to_use,
  const dominterop_secp_v0_10_0_fixed_asset_tag *fixed_output_tag,
 ...
 *
 * In:               ctx: pointer to a context object
 *           proof_out_p: pointer to a pointer to `dominterop_secp_v0_10_0_surjectionproof*`.
 ...
 *          input_index: The index of the actual input that is secretly mapped to the output
 */
SECP256K1_API SECP256K1_WARN_UNUSED_RESULT int dominterop_secp_v0_10_0_surjectionproof_allocate_initialized(
        const dominterop_secp_v0_10_0_context *ctx,
        dominterop_secp_v0_10_0_surjectionproof **proof_out_p,
        size_t *input_index,
        const dominterop_secp_v0_10_0_fixed_asset_tag *fixed_input_tags,
        const size_t n_input_tags,
        const size_t n_input_tags_to_use,
 ...
 *  deallocates the struct that was allocated with dominterop_secp_v0_10_0_surjectionproof_allocate_initialized
 *
 * In:               proof: pointer to dominterop_secp_v0_10_0_surjectionproof struct
 */
SECP256K1_API void dominterop_secp_v0_10_0_surjectionproof_destroy(
        dominterop_secp_v0_10_0_surjectionproof *proof
 ...
 *
 * In:                   ctx: pointer to a context object (not dominterop_secp_v0_10_0_context_static)
 ...
 * In/Out: proof: The produced surjection proof. Must have already gone through `dominterop_secp_v0_10_0_surjectionproof_initialize`
 */
SECP256K1_API SECP256K1_WARN_UNUSED_RESULT int dominterop_secp_v0_10_0_surjectionproof_generate(
  const dominterop_secp_v0_10_0_context *ctx,
  dominterop_secp_v0_10_0_surjectionproof *proof,
  const dominterop_secp_v0_10_0_generator *ephemeral_input_tags,
  size_t n_ephemeral_input_tags,
  const dominterop_secp_v0_10_0_generator *ephemeral_output_tag,
  size_t input_index,
 ...
 *      ephemeral_output_tag: the ephemeral asset tag of the output
 */
SECP256K1_API int dominterop_secp_v0_10_0_surjectionproof_verify(
  const dominterop_secp_v0_10_0_context *ctx,
  const dominterop_secp_v0_10_0_surjectionproof *proof,
  const dominterop_secp_v0_10_0_generator *ephemeral_input_tags,
  size_t n_ephemeral_input_tags,
