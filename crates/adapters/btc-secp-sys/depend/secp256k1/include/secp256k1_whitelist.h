 ...
 *
 *  To obtain these properties, instead use dominterop_secp_v0_10_0_whitelist_signature_parse
 *  and dominterop_secp_v0_10_0_whitelist_signature_serialize to encode/decode signatures
 ...
 *  of keys for a signature, use `dominterop_secp_v0_10_0_whitelist_signature_n_keys`.
 */
typedef struct {
    size_t n_keys;
    /* e0, scalars */
    unsigned char data[32 * (1 + SECP256K1_WHITELIST_MAX_N_KEYS)];
} dominterop_secp_v0_10_0_whitelist_signature;
 ...
 */
SECP256K1_API int dominterop_secp_v0_10_0_whitelist_signature_parse(
 ...
 */
SECP256K1_API size_t dominterop_secp_v0_10_0_whitelist_signature_n_keys(
    const dominterop_secp_v0_10_0_whitelist_signature *sig
 ...
 *
 *  See dominterop_secp_v0_10_0_whitelist_signature_parse for details about the encoding.
 */
SECP256K1_API int dominterop_secp_v0_10_0_whitelist_signature_serialize(
    const dominterop_secp_v0_10_0_context *ctx,
 ...
 */
SECP256K1_API int dominterop_secp_v0_10_0_whitelist_sign(
  const dominterop_secp_v0_10_0_context *ctx,
  dominterop_secp_v0_10_0_whitelist_signature *sig,
  const dominterop_secp_v0_10_0_pubkey *online_pubkeys,
  const dominterop_secp_v0_10_0_pubkey *offline_pubkeys,
  const size_t n_keys,
  const dominterop_secp_v0_10_0_pubkey *sub_pubkey,
 ...
 *         sub_pubkey: the key to be whitelisted
 */
SECP256K1_API int dominterop_secp_v0_10_0_whitelist_verify(
  const dominterop_secp_v0_10_0_context *ctx,
  const dominterop_secp_v0_10_0_whitelist_signature *sig,
  const dominterop_secp_v0_10_0_pubkey *online_pubkeys,
  const dominterop_secp_v0_10_0_pubkey *offline_pubkeys,
