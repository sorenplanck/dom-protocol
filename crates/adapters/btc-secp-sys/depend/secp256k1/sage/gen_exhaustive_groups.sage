...
for f in sorted(solutions.keys()):
    ...
    first = False
    print()
    print(f"static const dominterop_secp_v0_10_0_ge dominterop_secp_v0_10_0_ge_const_g = SECP256K1_G_ORDER_{f};")
    output_b(b)
    print()
print("#  else")
...
print("#else")
print()
print("static const dominterop_secp_v0_10_0_ge dominterop_secp_v0_10_0_ge_const_g = SECP256K1_G;")
output_b(7)
print()
print("#endif")
