...
*/
	...
	.align	2
	.global dominterop_secp_v0_10_0_fe_mul_inner
	.type	dominterop_secp_v0_10_0_fe_mul_inner, %function
	.hidden dominterop_secp_v0_10_0_fe_mul_inner
	@ Arguments:
...
dominterop_secp_v0_10_0_fe_mul_inner:
	...
	*/
	...
	.size	dominterop_secp_v0_10_0_fe_mul_inner, .-dominterop_secp_v0_10_0_fe_mul_inner

	.align	2
	.global dominterop_secp_v0_10_0_fe_sqr_inner
	.type	dominterop_secp_v0_10_0_fe_sqr_inner, %function
	.hidden dominterop_secp_v0_10_0_fe_sqr_inner
	@ Arguments:
	...
	@  sp + #0        saved 'r' pointer
	@  sp + #4 + 4*X  t0,t1,t2,t3,t4,t5,t6,t7,u8,t9
dominterop_secp_v0_10_0_fe_sqr_inner:
	stmfd	sp!, {r4, r5, r6, r7, r8, r9, r10, r11, r14}
	sub	sp, sp, #48			@ frame=44 + alignment
	str     r0, [sp, #0]			@ save result address, we need it only at the end
	/******************************************
	...
	*/
	...
	add	sp, sp, #48
	ldmfd	sp!, {r4, r5, r6, r7, r8, r9, r10, r11, pc}
	.size	dominterop_secp_v0_10_0_fe_sqr_inner, .-dominterop_secp_v0_10_0_fe_sqr_inner
