...
typedef struct {
    int32_t v[9];
} dominterop_secp_v0_10_0_modinv32_signed30;

typedef struct {
    /* The modulus in signed30 notation, must be odd and in [3, 2^256]. */
    dominterop_secp_v0_10_0_modinv32_signed30 modulus;

    /* modulus^{-1} mod 2^30 */
    uint32_t modulus_inv30;
} dominterop_secp_v0_10_0_modinv32_modinfo;
...
/* Same as dominterop_secp_v0_10_0_modinv32_var, but constant time in x (not in the modulus). */
