...
typedef struct {
    int64_t v[5];
} dominterop_secp_v0_10_0_modinv64_signed62;

typedef struct {
    /* The modulus in signed62 notation, must be odd and in [3, 2^256]. */
    dominterop_secp_v0_10_0_modinv64_signed62 modulus;

    /* modulus^{-1} mod 2^62 */
    uint64_t modulus_inv62;
} dominterop_secp_v0_10_0_modinv64_modinfo;
...
/* Same as dominterop_secp_v0_10_0_modinv64_var, but constant time in x (not in the modulus). */
