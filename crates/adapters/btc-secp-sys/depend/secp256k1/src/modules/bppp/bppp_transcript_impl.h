 ...
 */
static void dominterop_secp_v0_10_0_bppp_sha256_tagged_commitment_init(dominterop_secp_v0_10_0_sha256 *sha) {
...
static void dominterop_secp_v0_10_0_bppp_challenge_scalar(dominterop_secp_v0_10_0_scalar* ch, const dominterop_secp_v0_10_0_sha256 *transcript, uint64_t idx) {
    unsigned char buf[32];
    dominterop_secp_v0_10_0_sha256 sha = *transcript;
    dominterop_secp_v0_10_0_bppp_le64(buf, idx);
    dominterop_secp_v0_10_0_sha256_write(&sha, buf, 8);
    dominterop_secp_v0_10_0_sha256_finalize(&sha, buf);
    dominterop_secp_v0_10_0_scalar_set_b32(ch, buf, NULL);
}
