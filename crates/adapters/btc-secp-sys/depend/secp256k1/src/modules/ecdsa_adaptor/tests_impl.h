...
static void rand_scalar(dominterop_secp_v0_10_0_scalar *scalar) {
    unsigned char buf32[32];
    dominterop_secp_v0_10_0_testrand256(buf32);
    dominterop_secp_v0_10_0_scalar_set_b32(scalar, buf32, NULL);
}

static void rand_point(dominterop_secp_v0_10_0_ge *point) {
    dominterop_secp_v0_10_0_scalar x;
    dominterop_secp_v0_10_0_gej pointj;
    rand_scalar(&x);

    dominterop_secp_v0_10_0_ecmult_gen(&CTX->ecmult_gen_ctx, &pointj, &x);
    dominterop_secp_v0_10_0_ge_set_gej(point, &pointj);
}

static void dleq_nonce_bitflip(unsigned char **args, size_t n_flip, size_t n_bytes) {
    dominterop_secp_v0_10_0_scalar k1, k2;

    CHECK(dominterop_secp_v0_10_0_dleq_nonce(&k1, args[0], args[1], args[2], args[3], NULL, args[4]) == 1);
    dominterop_secp_v0_10_0_testrand_flip(args[n_flip], n_bytes);
    CHECK(dominterop_secp_v0_10_0_dleq_nonce(&k2, args[0], args[1], args[2], args[3], NULL, args[4]) == 1);
    CHECK(dominterop_secp_v0_10_0_scalar_eq(&k1, &k2) == 0);
}

static void dleq_tests(void) {
    dominterop_secp_v0_10_0_scalar s, e, sk, k;
    dominterop_secp_v0_10_0_ge gen2, p1, p2;
    ...
    rand_point(&gen2);
    rand_scalar(&sk);
    dominterop_secp_v0_10_0_dleq_pair(&CTX->ecmult_gen_ctx, &p1, &p2, &sk, &gen2);
    CHECK(dominterop_secp_v0_10_0_dleq_prove(CTX, &s, &e, &sk, &gen2, &p1, &p2, NULL, NULL) == 1);
    CHECK(dominterop_secp_v0_10_0_dleq_verify(&s, &e, &p1, &gen2, &p2) == 1);

    {
        dominterop_secp_v0_10_0_scalar tmp;
        dominterop_secp_v0_10_0_scalar_set_int(&tmp, 1);
        CHECK(dominterop_secp_v0_10_0_dleq_verify(&tmp, &e, &p1, &gen2, &p2) == 0);
        CHECK(dominterop_secp_v0_10_0_dleq_verify(&s, &tmp, &p1, &gen2, &p2) == 0);
    }
    {
        dominterop_secp_v0_10_0_ge p_tmp;
        rand_point(&p_tmp);
        CHECK(dominterop_secp_v0_10_0_dleq_verify(&s, &e, &p_tmp, &gen2, &p2) == 0);
        CHECK(dominterop_secp_v0_10_0_dleq_verify(&s, &e, &p1, &p_tmp, &p2) == 0);
        CHECK(dominterop_secp_v0_10_0_dleq_verify(&s, &e, &p1, &gen2, &p_tmp) == 0);
    }
    {
        dominterop_secp_v0_10_0_ge p_inf;
        dominterop_secp_v0_10_0_ge_set_infinity(&p_inf);
        CHECK(dominterop_secp_v0_10_0_dleq_prove(CTX, &s, &e, &sk, &p_inf, &p1, &p2, NULL, NULL) == 0);
        CHECK(dominterop_secp_v0_10_0_dleq_prove(CTX, &s, &e, &sk, &gen2, &p_inf, &p2, NULL, NULL) == 0);
        CHECK(dominterop_secp_v0_10_0_dleq_prove(CTX, &s, &e, &sk, &gen2, &p1, &p_inf, NULL, NULL) == 0);
    }

    /* Nonce tests */
    dominterop_secp_v0_10_0_scalar_get_b32(sk32, &sk);
    CHECK(dominterop_secp_v0_10_0_eckey_pubkey_serialize(&gen2, gen2_33, &pubkey_size, 1));
    CHECK(dominterop_secp_v0_10_0_eckey_pubkey_serialize(&p1, p1_33, &pubkey_size, 1));
    CHECK(dominterop_secp_v0_10_0_eckey_pubkey_serialize(&p2, p2_33, &pubkey_size, 1));
    CHECK(dominterop_secp_v0_10_0_dleq_nonce(&k, sk32, gen2_33, p1_33, p2_33, NULL, NULL) == 1);

    dominterop_secp_v0_10_0_testrand_bytes_test(sk32, sizeof(sk32));
    dominterop_secp_v0_10_0_testrand_bytes_test(gen2_33, sizeof(gen2_33));
    dominterop_secp_v0_10_0_testrand_bytes_test(p1_33, sizeof(p1_33));
    dominterop_secp_v0_10_0_testrand_bytes_test(p2_33, sizeof(p2_33));
    dominterop_secp_v0_10_0_testrand_bytes_test(aux_rand, sizeof(aux_rand));
...
static void rand_flip_bit(unsigned char *array, size_t n) {
    array[dominterop_secp_v0_10_0_testrand_int(n)] ^= 1 << dominterop_secp_v0_10_0_testrand_int(8);
}
...
static void test_ecdsa_adaptor_spec_vectors_check_verify(const unsigned char *adaptor_sig162, const unsigned char *msg32, const unsigned char *pubkey33, const unsigned char *encryption_key33, int expected) {
    ...
    dominterop_secp_v0_10_0_pubkey encryption_key;
    dominterop_secp_v0_10_0_ge encryption_key_ge;

    CHECK(dominterop_secp_v0_10_0_eckey_pubkey_parse(&encryption_key_ge, encryption_key33, 33) == 1);
    dominterop_secp_v0_10_0_pubkey_save(&encryption_key, &encryption_key_ge);
    CHECK(dominterop_secp_v0_10_0_eckey_pubkey_parse(&pubkey_ge, pubkey33, 33) == 1);
    dominterop_secp_v0_10_0_pubkey_save(&pubkey, &pubkey_ge);

    CHECK(expected == dominterop_secp_v0_10_0_ecdsa_adaptor_verify(CTX, adaptor_sig162, &pubkey, msg32, &encryption_key));
}
...
static void test_ecdsa_adaptor_spec_vectors_check_decrypt(const unsigned char *adaptor_sig162, const unsigned char *decryption_key32, const unsigned char *signature64, int expected) {
    ...
    dominterop_secp_v0_10_0_ecdsa_signature s;

    CHECK(dominterop_secp_v0_10_0_ecdsa_adaptor_decrypt(CTX, &s, decryption_key32, adaptor_sig162) == 1);
    CHECK(dominterop_secp_v0_10_0_ecdsa_signature_serialize_compact(CTX, signature, &s) == 1);

    CHECK(expected == !(dominterop_secp_v0_10_0_memcmp_var(signature, signature64, 64)));
}
...
static void test_ecdsa_adaptor_spec_vectors_check_recover(const unsigned char *adaptor_sig162, const unsigned char *encryption_key33, const unsigned char *decryption_key32, const unsigned char *signature64, int expected) {
    ...
    CHECK(dominterop_secp_v0_10_0_ecdsa_signature_parse_compact(CTX, &sig, signature64) == 1);
    CHECK(expected == dominterop_secp_v0_10_0_ecdsa_adaptor_recover(CTX, deckey32, &sig, adaptor_sig162, &encryption_key));
    if (decryption_key32 != NULL) {
        CHECK(expected == !(dominterop_secp_v0_10_0_memcmp_var(deckey32, decryption_key32, 32)));
    }
}
...
static void test_ecdsa_adaptor_spec_vectors_check_serialization(const unsigned char *adaptor_sig162, int expected) {
    ...
    CHECK(expected == dominterop_secp_v0_10_0_ecdsa_adaptor_sig_deserialize(&r, &sigr, &rp, &sp, &dleq_proof_e, &dleq_proof_s, adaptor_sig162));
    if (expected == 1) {
        CHECK(dominterop_secp_v0_10_0_ecdsa_adaptor_sig_serialize(buf, &r, &rp, &sp, &dleq_proof_e, &dleq_proof_s) == 1);
        CHECK(dominterop_secp_v0_10_0_memcmp_var(buf, adaptor_sig162, 162) == 0);
    }
}
...
static void nonce_function_ecdsa_adaptor_bitflip(unsigned char **args, size_t n_flip, size_t n_bytes, size_t algolen) {
    ...
    CHECK(dominterop_secp_v0_10_0_memcmp_var(nonces[0], nonces[1], 32) != 0);
}

/* Tests for the equality of two sha256 structs. This function only produces a
 * correct result if an integer multiple of 64 many bytes have been written
 * into the hash functions. */
static void ecdsa_adaptor_test_sha256_eq(const dominterop_secp_v0_10_0_sha256 *sha1, const dominterop_secp_v0_10_0_sha256 *sha2) {
...
static void run_nonce_function_ecdsa_adaptor_tests(void) {
    ...
    dominterop_secp_v0_10_0_sha256 sha_optimized;
     ...
     * dominterop_secp_v0_10_0_nonce_function_ecdsa_adaptor_sha256_tagged has the expected
     * state. */
    dominterop_secp_v0_10_0_sha256_initialize_tagged(&sha, tag, sizeof(tag));
    dominterop_secp_v0_10_0_nonce_function_ecdsa_adaptor_sha256_tagged(&sha_optimized);
    ecdsa_adaptor_test_sha256_eq(&sha, &sha_optimized);

   /* Check that hash initialized by
    * dominterop_secp_v0_10_0_nonce_function_ecdsa_adaptor_sha256_tagged_aux has the expected
    * state. */
    dominterop_secp_v0_10_0_sha256_initialize_tagged(&sha, aux_tag, sizeof(aux_tag));
    dominterop_secp_v0_10_0_nonce_function_ecdsa_adaptor_sha256_tagged_aux(&sha_optimized);
    ecdsa_adaptor_test_sha256_eq(&sha, &sha_optimized);

   /* Check that hash initialized by
    * dominterop_secp_v0_10_0_nonce_function_dleq_sha256_tagged_aux has the expected
    * state. */
    dominterop_secp_v0_10_0_sha256_initialize_tagged(&sha, dleq_tag, sizeof(dleq_tag));
    dominterop_secp_v0_10_0_nonce_function_dleq_sha256_tagged(&sha_optimized);
    ecdsa_adaptor_test_sha256_eq(&sha, &sha_optimized);

    dominterop_secp_v0_10_0_testrand_bytes_test(msg, sizeof(msg));
    dominterop_secp_v0_10_0_testrand_bytes_test(key, sizeof(key));
    ...
    for (i = 0; i < COUNT; i++) {
        ...
        uint32_t offset = dominterop_secp_v0_10_0_testrand_int(algolen - 1);
...
static void test_ecdsa_adaptor_api(void) {
    dominterop_secp_v0_10_0_pubkey pubkey;
    dominterop_secp_v0_10_0_pubkey enckey;
    dominterop_secp_v0_10_0_pubkey zero_pk;
    dominterop_secp_v0_10_0_ecdsa_signature sig;
    unsigned char sk[32];
    unsigned char msg[32];
    ...
    /** setup **/
    dominterop_secp_v0_10_0_testrand256(sk);
    dominterop_secp_v0_10_0_testrand256(msg);
    dominterop_secp_v0_10_0_testrand256(deckey);
    CHECK(dominterop_secp_v0_10_0_ec_pubkey_create(CTX, &pubkey, sk) == 1);
    CHECK(dominterop_secp_v0_10_0_ec_pubkey_create(CTX, &enckey, deckey) == 1);
    memset(&zero_pk, 0, sizeof(zero_pk));

    /** main test body **/
    CHECK(dominterop_secp_v0_10_0_ecdsa_adaptor_encrypt(CTX, asig, sk, &enckey, msg, NULL, NULL) == 1);
    CHECK_ILLEGAL(STATIC_CTX, dominterop_secp_v0_10_0_ecdsa_adaptor_encrypt(STATIC_CTX, asig, sk, &enckey, msg, NULL, NULL));
    CHECK_ILLEGAL(CTX, dominterop_secp_v0_10_0_ecdsa_adaptor_encrypt(CTX, NULL, sk, &enckey, msg, NULL, NULL));
    CHECK_ILLEGAL(CTX, dominterop_secp_v0_10_0_ecdsa_adaptor_encrypt(CTX, asig, sk, &enckey, NULL, NULL, NULL));
    CHECK_ILLEGAL(CTX, dominterop_secp_v0_10_0_ecdsa_adaptor_encrypt(CTX, asig, NULL, &enckey, msg, NULL, NULL));
    CHECK_ILLEGAL(CTX, dominterop_secp_v0_10_0_ecdsa_adaptor_encrypt(CTX, asig, sk, NULL, msg, NULL, NULL));
    CHECK_ILLEGAL(CTX, dominterop_secp_v0_10_0_ecdsa_adaptor_encrypt(CTX, asig, sk, &zero_pk, msg, NULL, NULL));

    CHECK(dominterop_secp_v0_10_0_ecdsa_adaptor_encrypt(CTX, asig, sk, &enckey, msg, NULL, NULL) == 1);
    CHECK(dominterop_secp_v0_10_0_ecdsa_adaptor_verify(CTX, asig, &pubkey, msg, &enckey) == 1);
    CHECK_ILLEGAL(CTX, dominterop_secp_v0_10_0_ecdsa_adaptor_verify(CTX, NULL, &pubkey, msg, &enckey));
    CHECK_ILLEGAL(CTX, dominterop_secp_v0_10_0_ecdsa_adaptor_verify(CTX, asig, &pubkey, NULL, &enckey));
    CHECK_ILLEGAL(CTX, dominterop_secp_v0_10_0_ecdsa_adaptor_verify(CTX, asig, &pubkey, msg, NULL));
    CHECK_ILLEGAL(CTX, dominterop_secp_v0_10_0_ecdsa_adaptor_verify(CTX, asig, NULL, msg, &enckey));
    CHECK_ILLEGAL(CTX, dominterop_secp_v0_10_0_ecdsa_adaptor_verify(CTX, asig, &zero_pk, msg, &enckey));
    CHECK_ILLEGAL(CTX, dominterop_secp_v0_10_0_ecdsa_adaptor_verify(CTX, asig, &pubkey, msg, &zero_pk));

    CHECK(dominterop_secp_v0_10_0_ecdsa_adaptor_decrypt(CTX, &sig, deckey, asig) == 1);
    CHECK(dominterop_secp_v0_10_0_ecdsa_adaptor_decrypt(CTX, &sig, deckey, asig) == 1);
    CHECK_ILLEGAL(CTX, dominterop_secp_v0_10_0_ecdsa_adaptor_decrypt(CTX, NULL, deckey, asig));
    CHECK_ILLEGAL(CTX, dominterop_secp_v0_10_0_ecdsa_adaptor_decrypt(CTX, &sig, NULL, asig));
    CHECK_ILLEGAL(CTX, dominterop_secp_v0_10_0_ecdsa_adaptor_decrypt(CTX, &sig, deckey, NULL));

    CHECK(dominterop_secp_v0_10_0_ecdsa_adaptor_decrypt(CTX, &sig, deckey, asig) == 1);
    CHECK(dominterop_secp_v0_10_0_ecdsa_adaptor_recover(CTX, deckey, &sig, asig, &enckey) == 1);
    CHECK_ILLEGAL(STATIC_CTX, dominterop_secp_v0_10_0_ecdsa_adaptor_recover(STATIC_CTX, deckey, &sig, asig, &enckey));
    CHECK_ILLEGAL(CTX, dominterop_secp_v0_10_0_ecdsa_adaptor_recover(CTX, NULL, &sig, asig, &enckey));
    CHECK_ILLEGAL(CTX, dominterop_secp_v0_10_0_ecdsa_adaptor_recover(CTX, deckey, NULL, asig, &enckey));
    CHECK_ILLEGAL(CTX, dominterop_secp_v0_10_0_ecdsa_adaptor_recover(CTX, deckey, &sig, NULL, &enckey));
    CHECK_ILLEGAL(CTX, dominterop_secp_v0_10_0_ecdsa_adaptor_recover(CTX, deckey, &sig, asig, NULL));
    CHECK_ILLEGAL(CTX, dominterop_secp_v0_10_0_ecdsa_adaptor_recover(CTX, deckey, &sig, asig, &zero_pk));
}
...
static void adaptor_tests(void) {
    ...
    dominterop_secp_v0_10_0_testrand256(seckey);
    dominterop_secp_v0_10_0_testrand256(msg);
    dominterop_secp_v0_10_0_testrand256(deckey);

    CHECK(dominterop_secp_v0_10_0_ec_pubkey_create(CTX, &pubkey, seckey) == 1);
    CHECK(dominterop_secp_v0_10_0_ec_pubkey_create(CTX, &enckey, deckey) == 1);
    CHECK(dominterop_secp_v0_10_0_ecdsa_adaptor_encrypt(CTX, adaptor_sig, seckey, &enckey, msg, NULL, NULL) == 1);

    {
        /* Test overflowing seckey */
        memset(big, 0xFF, 32);
        CHECK(dominterop_secp_v0_10_0_ecdsa_adaptor_encrypt(CTX, adaptor_sig, big, &enckey, msg, NULL, NULL) == 0);
        CHECK(dominterop_secp_v0_10_0_memcmp_var(adaptor_sig, zeros162, sizeof(adaptor_sig)) == 0);

        /* Test different nonce functions */
        memset(adaptor_sig, 1, sizeof(adaptor_sig));
        CHECK(dominterop_secp_v0_10_0_ecdsa_adaptor_encrypt(CTX, adaptor_sig, seckey, &enckey, msg, ecdsa_adaptor_nonce_function_failing, NULL) == 0);
        CHECK(dominterop_secp_v0_10_0_memcmp_var(adaptor_sig, zeros162, sizeof(adaptor_sig)) == 0);
        memset(&adaptor_sig, 1, sizeof(adaptor_sig));
        CHECK(dominterop_secp_v0_10_0_ecdsa_adaptor_encrypt(CTX, adaptor_sig, seckey, &enckey, msg, ecdsa_adaptor_nonce_function_0, NULL) == 0);
        CHECK(dominterop_secp_v0_10_0_memcmp_var(adaptor_sig, zeros162, sizeof(adaptor_sig)) == 0);
        CHECK(dominterop_secp_v0_10_0_ecdsa_adaptor_encrypt(CTX, adaptor_sig, seckey, &enckey, msg, ecdsa_adaptor_nonce_function_overflowing, NULL) == 1);
        CHECK(dominterop_secp_v0_10_0_memcmp_var(adaptor_sig, zeros162, sizeof(adaptor_sig)) != 0);
    }
    {
        ...
        CHECK(dominterop_secp_v0_10_0_ecdsa_adaptor_sig_deserialize(&r, &sigr, &rp, &sp, &dleq_proof_e, &dleq_proof_s, adaptor_sig) == 1);

        CHECK(dominterop_secp_v0_10_0_ecdsa_adaptor_sig_serialize(adaptor_sig_tmp, &r, &rp, &sp, &dleq_proof_e, &dleq_proof_s) == 1);
        CHECK(dominterop_secp_v0_10_0_memcmp_var(adaptor_sig_tmp, adaptor_sig, sizeof(adaptor_sig_tmp)) == 0);

        /* Test adaptor_sig_serialize points at infinity */
        dominterop_secp_v0_10_0_ge_set_infinity(&p_inf);
        CHECK(dominterop_secp_v0_10_0_ecdsa_adaptor_sig_serialize(adaptor_sig_tmp, &p_inf, &rp, &sp, &dleq_proof_e, &dleq_proof_s) == 0);
        CHECK(dominterop_secp_v0_10_0_ecdsa_adaptor_sig_serialize(adaptor_sig_tmp, &r, &p_inf, &sp, &dleq_proof_e, &dleq_proof_s) == 0);
    }
    {
        ...
        /* r */
        CHECK(dominterop_secp_v0_10_0_ecdsa_adaptor_sig_deserialize(&r, &sigr, NULL, NULL, NULL, NULL, adaptor_sig) == 1);
        memcpy(adaptor_sig_tmp, adaptor_sig, sizeof(adaptor_sig_tmp));
        memset(&adaptor_sig_tmp[0], 0xFF, 33);
        CHECK(dominterop_secp_v0_10_0_ecdsa_adaptor_sig_deserialize(&r, &sigr, NULL, NULL, NULL, NULL, adaptor_sig_tmp) == 0);

        /* sigr */
        CHECK(dominterop_secp_v0_10_0_ecdsa_adaptor_sig_deserialize(NULL, &sigr, NULL, NULL, NULL, NULL, adaptor_sig) == 1);
        memcpy(adaptor_sig_tmp, adaptor_sig, sizeof(adaptor_sig_tmp));
        memset(&adaptor_sig_tmp[1], 0xFF, 32);
        CHECK(dominterop_secp_v0_10_0_ecdsa_adaptor_sig_deserialize(NULL, &sigr, NULL, NULL, NULL, NULL, adaptor_sig_tmp) == 1);
        memset(&adaptor_sig_tmp[1], 0, 32);
        CHECK(dominterop_secp_v0_10_0_ecdsa_adaptor_sig_deserialize(NULL, &sigr, NULL, NULL, NULL, NULL, adaptor_sig_tmp) == 0);

        /* rp */
        CHECK(dominterop_secp_v0_10_0_ecdsa_adaptor_sig_deserialize(NULL, NULL, &rp, NULL, NULL, NULL, adaptor_sig) == 1);
        memcpy(adaptor_sig_tmp, adaptor_sig, sizeof(adaptor_sig_tmp));
        memset(&adaptor_sig_tmp[33], 0xFF, 33);
        CHECK(dominterop_secp_v0_10_0_ecdsa_adaptor_sig_deserialize(NULL, NULL, &rp, NULL, NULL, NULL, adaptor_sig_tmp) == 0);

        /* sp */
        CHECK(dominterop_secp_v0_10_0_ecdsa_adaptor_sig_deserialize(NULL, NULL, NULL, &sp, NULL, NULL, adaptor_sig) == 1);
        memcpy(adaptor_sig_tmp, adaptor_sig, sizeof(adaptor_sig_tmp));
        memset(&adaptor_sig_tmp[66], 0xFF, 32);
        CHECK(dominterop_secp_v0_10_0_ecdsa_adaptor_sig_deserialize(NULL, NULL, NULL, &sp, NULL, NULL, adaptor_sig_tmp) == 0);

        /* dleq_proof_e */
        CHECK(dominterop_secp_v0_10_0_ecdsa_adaptor_sig_deserialize(NULL, NULL, NULL, NULL, &dleq_proof_e, NULL, adaptor_sig) == 1);
        memcpy(adaptor_sig_tmp, adaptor_sig, sizeof(adaptor_sig_tmp));
        memset(&adaptor_sig_tmp[98], 0xFF, 32);
        CHECK(dominterop_secp_v0_10_0_ecdsa_adaptor_sig_deserialize(NULL, NULL, NULL, NULL, &dleq_proof_e, NULL, adaptor_sig_tmp) == 1);

        /* dleq_proof_s */
        CHECK(dominterop_secp_v0_10_0_ecdsa_adaptor_sig_deserialize(NULL, NULL, NULL, NULL, NULL, &dleq_proof_s, adaptor_sig) == 1);
        memcpy(adaptor_sig_tmp, adaptor_sig, sizeof(adaptor_sig_tmp));
        memset(&adaptor_sig_tmp[130], 0xFF, 32);
        CHECK(dominterop_secp_v0_10_0_ecdsa_adaptor_sig_deserialize(NULL, NULL, NULL, NULL, NULL, &dleq_proof_s, adaptor_sig_tmp) == 0);
    }

    /* Test adaptor_sig_verify */
    CHECK(dominterop_secp_v0_10_0_ecdsa_adaptor_verify(CTX, adaptor_sig, &pubkey, msg, &enckey) == 1);
    CHECK(dominterop_secp_v0_10_0_ecdsa_adaptor_verify(CTX, adaptor_sig, &enckey, msg, &enckey) == 0);
    CHECK(dominterop_secp_v0_10_0_ecdsa_adaptor_verify(CTX, adaptor_sig, &pubkey, msg, &pubkey) == 0);
    {
        /* Test failed adaptor sig deserialization */
        unsigned char adaptor_sig_tmp[162];
        memset(&adaptor_sig_tmp, 0xFF, 162);
        CHECK(dominterop_secp_v0_10_0_ecdsa_adaptor_verify(CTX, adaptor_sig_tmp, &pubkey, msg, &enckey) == 0);
    }
    {
    ...
    }
    {
        ...
        CHECK(dominterop_secp_v0_10_0_ecdsa_adaptor_verify(CTX, adaptor_sig, &pubkey, msg_tmp, &enckey) == 0);
    }
    {
        ...
        dominterop_secp_v0_10_0_scalar sigr, t, m;

        /* m := t * sigr */
        CHECK(dominterop_secp_v0_10_0_ecdsa_adaptor_sig_deserialize(NULL, &sigr, NULL, NULL, NULL, NULL, adaptor_sig) == 1);
        dominterop_secp_v0_10_0_scalar_set_b32(&t, target, NULL);
        dominterop_secp_v0_10_0_scalar_mul(&m, &t, &sigr);
        dominterop_secp_v0_10_0_scalar_get_b32(msg_tmp, &m);

        /* X := G */
        seckey_tmp[31] = 1;
        CHECK(dominterop_secp_v0_10_0_ec_pubkey_create(CTX, &pubkey_tmp, seckey_tmp) == 1);

        /* sp := sigr */
        memcpy(adaptor_sig_tmp, adaptor_sig, sizeof(adaptor_sig_tmp));
        memcpy(&adaptor_sig_tmp[66], &adaptor_sig_tmp[1], 32);

        CHECK(dominterop_secp_v0_10_0_ecdsa_adaptor_verify(CTX, adaptor_sig_tmp, &pubkey_tmp, msg_tmp, &enckey) == 0);
    }

    /* Test decryption */
    CHECK(dominterop_secp_v0_10_0_ecdsa_adaptor_decrypt(CTX, &sig, deckey, adaptor_sig) == 1);
...

    {
        ...
        dominterop_secp_v0_10_0_ecdsa_signature s;
        memset(big, 0xFF, 32);
        CHECK(dominterop_secp_v0_10_0_ecdsa_adaptor_decrypt(CTX, &s, big, adaptor_sig) == 0);
        CHECK(dominterop_secp_v0_10_0_memcmp_var(&s.data[0], zeros64, sizeof(&s.data[0])) == 0);
    }
    {
        /* Test key recover */
        ...
        CHECK(dominterop_secp_v0_10_0_ecdsa_adaptor_recover(CTX, decryption_key_tmp, &sig, adaptor_sig, &enckey) == 1);
        CHECK(dominterop_secp_v0_10_0_memcmp_var(deckey, decryption_key_tmp, sizeof(deckey)) == 0);

        /* Test failed sp deserialization */
        memcpy(adaptor_sig_tmp, adaptor_sig, sizeof(adaptor_sig_tmp));
        memset(&adaptor_sig_tmp[66], 0xFF, 32);
        CHECK(dominterop_secp_v0_10_0_ecdsa_adaptor_recover(CTX, decryption_key_tmp, &sig, adaptor_sig_tmp, &enckey) == 0);
    }
}
...
static void multi_hop_lock_tests(void) {
    ...
    dominterop_secp_v0_10_0_pubkey pubkey_pop;
    dominterop_secp_v0_10_0_pubkey pubkey_a, pubkey_b;
    dominterop_secp_v0_10_0_pubkey l, r;
    dominterop_secp_v0_10_0_ge l_ge, r_ge;
    dominterop_secp_v0_10_0_scalar t1, t2, tp;
    dominterop_secp_v0_10_0_scalar deckey;
    dominterop_secp_v0_10_0_ecdsa_signature sig_ab, sig_bc;

    dominterop_secp_v0_10_0_testrand256(seckey_a);
    dominterop_secp_v0_10_0_testrand256(seckey_b);

    CHECK(dominterop_secp_v0_10_0_ec_pubkey_create(CTX, &pubkey_a, seckey_a));
    CHECK(dominterop_secp_v0_10_0_ec_pubkey_create(CTX, &pubkey_b, seckey_b));

    /* Carol setup */
    /* Proof of payment */
    dominterop_secp_v0_10_0_testrand256(pop);
    CHECK(dominterop_secp_v0_10_0_ec_pubkey_create(CTX, &pubkey_pop, pop));

    /* Alice setup */
    dominterop_secp_v0_10_0_testrand256(tx_ab);
    rand_scalar(&t1);
    rand_scalar(&t2);
    dominterop_secp_v0_10_0_scalar_add(&tp, &t1, &t2);
    /* Left lock */
    dominterop_secp_v0_10_0_pubkey_load(CTX, &l_ge, &pubkey_pop);
    CHECK(dominterop_secp_v0_10_0_eckey_pubkey_tweak_add(&l_ge, &t1));
    dominterop_secp_v0_10_0_pubkey_save(&l, &l_ge);
    /* Right lock */
    dominterop_secp_v0_10_0_pubkey_load(CTX, &r_ge, &pubkey_pop);
    CHECK(dominterop_secp_v0_10_0_eckey_pubkey_tweak_add(&r_ge, &tp));
    dominterop_secp_v0_10_0_pubkey_save(&r, &r_ge);
    CHECK(dominterop_secp_v0_10_0_ecdsa_adaptor_encrypt(CTX, asig_ab, seckey_a, &l, tx_ab, NULL, NULL));

    /* Bob setup */
    CHECK(dominterop_secp_v0_10_0_ecdsa_adaptor_verify(CTX, asig_ab, &pubkey_a, tx_ab, &l));
    dominterop_secp_v0_10_0_testrand256(tx_bc);
    CHECK(dominterop_secp_v0_10_0_ecdsa_adaptor_encrypt(CTX, asig_bc, seckey_b, &r, tx_bc, NULL, NULL));

    /* Carol decrypt */
    CHECK(dominterop_secp_v0_10_0_ecdsa_adaptor_verify(CTX, asig_bc, &pubkey_b, tx_bc, &r));
    dominterop_secp_v0_10_0_scalar_set_b32(&deckey, pop, NULL);
    dominterop_secp_v0_10_0_scalar_add(&deckey, &deckey, &tp);
    dominterop_secp_v0_10_0_scalar_get_b32(buf, &deckey);
    CHECK(dominterop_secp_v0_10_0_ecdsa_adaptor_decrypt(CTX, &sig_bc, buf, asig_bc));
    CHECK(dominterop_secp_v0_10_0_ecdsa_verify(CTX, &sig_bc, tx_bc, &pubkey_b));

    /* Bob recover and decrypt */
    CHECK(dominterop_secp_v0_10_0_ecdsa_adaptor_recover(CTX, buf, &sig_bc, asig_bc, &r));
    dominterop_secp_v0_10_0_scalar_set_b32(&deckey, buf, NULL);
    dominterop_secp_v0_10_0_scalar_negate(&t2, &t2);
    dominterop_secp_v0_10_0_scalar_add(&deckey, &deckey, &t2);
    dominterop_secp_v0_10_0_scalar_get_b32(buf, &deckey);
    CHECK(dominterop_secp_v0_10_0_ecdsa_adaptor_decrypt(CTX, &sig_ab, buf, asig_ab));
    CHECK(dominterop_secp_v0_10_0_ecdsa_verify(CTX, &sig_ab, tx_ab, &pubkey_a));

    /* Alice recover and derive proof of payment */
    CHECK(dominterop_secp_v0_10_0_ecdsa_adaptor_recover(CTX, buf, &sig_ab, asig_ab, &l));
    dominterop_secp_v0_10_0_scalar_set_b32(&deckey, buf, NULL);
    dominterop_secp_v0_10_0_scalar_negate(&t1, &t1);
    dominterop_secp_v0_10_0_scalar_add(&deckey, &deckey, &t1);
    dominterop_secp_v0_10_0_scalar_get_b32(buf, &deckey);
    CHECK(dominterop_secp_v0_10_0_memcmp_var(buf, pop, 32) == 0);
}
