...
int main(int argc, char **argv) {
    ...
    fprintf(fp, "const dominterop_secp_v0_10_0_ge_storage dominterop_secp_v0_10_0_ecmult_gen_prec_table[ECMULT_GEN_PREC_N(ECMULT_GEN_PREC_BITS)][ECMULT_GEN_PREC_G(ECMULT_GEN_PREC_BITS)] = {\n");
    ...
    for (bits = 2; bits <= 8; bits *= 2) {
        ...
        dominterop_secp_v0_10_0_ge_storage* table = checked_malloc(&default_error_callback, n * g * sizeof(dominterop_secp_v0_10_0_ge_storage));
        dominterop_secp_v0_10_0_ecmult_gen_compute_table(table, &dominterop_secp_v0_10_0_ge_const_g, bits);
