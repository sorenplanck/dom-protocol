...
SECP256K1_INLINE static int dominterop_secp_v0_10_0_scalar_reduce(dominterop_secp_v0_10_0_scalar *r, uint32_t overflow) {
    uint64_t t;
...
static int dominterop_secp_v0_10_0_scalar_add(dominterop_secp_v0_10_0_scalar *r, const dominterop_secp_v0_10_0_scalar *a, const dominterop_secp_v0_10_0_scalar *b) {
    ...
    overflow = t + dominterop_secp_v0_10_0_scalar_check_overflow(r);
...
static void dominterop_secp_v0_10_0_scalar_set_b32(dominterop_secp_v0_10_0_scalar *r, const unsigned char *b32, int *overflow) {
    int over;
    r->d[0] = dominterop_secp_v0_10_0_read_be32(&b32[28]);
    r->d[1] = dominterop_secp_v0_10_0_read_be32(&b32[24]);
    r->d[2] = dominterop_secp_v0_10_0_read_be32(&b32[20]);
    r->d[3] = dominterop_secp_v0_10_0_read_be32(&b32[16]);
    r->d[4] = dominterop_secp_v0_10_0_read_be32(&b32[12]);
    r->d[5] = dominterop_secp_v0_10_0_read_be32(&b32[8]);
    r->d[6] = dominterop_secp_v0_10_0_read_be32(&b32[4]);
    r->d[7] = dominterop_secp_v0_10_0_read_be32(&b32[0]);
...
static void dominterop_secp_v0_10_0_scalar_get_b32(unsigned char *bin, const dominterop_secp_v0_10_0_scalar* a) {
    ...
    dominterop_secp_v0_10_0_write_be32(&bin[0], a->d[7]);
    dominterop_secp_v0_10_0_write_be32(&bin[4], a->d[6]);
    dominterop_secp_v0_10_0_write_be32(&bin[8], a->d[5]);
    dominterop_secp_v0_10_0_write_be32(&bin[12], a->d[4]);
    dominterop_secp_v0_10_0_write_be32(&bin[16], a->d[3]);
    dominterop_secp_v0_10_0_write_be32(&bin[20], a->d[2]);
    dominterop_secp_v0_10_0_write_be32(&bin[24], a->d[1]);
    dominterop_secp_v0_10_0_write_be32(&bin[28], a->d[0]);
}
...
static void dominterop_secp_v0_10_0_scalar_negate(dominterop_secp_v0_10_0_scalar *r, const dominterop_secp_v0_10_0_scalar *a) {
    uint32_t nonzero = 0xFFFFFFFFUL * (dominterop_secp_v0_10_0_scalar_is_zero(a) == 0);
...
static int dominterop_secp_v0_10_0_scalar_cond_negate(dominterop_secp_v0_10_0_scalar *r, int flag) {
    ...
    volatile int vflag = flag;
    uint32_t mask = -vflag;
    uint32_t nonzero = 0xFFFFFFFFUL * (dominterop_secp_v0_10_0_scalar_is_zero(r) == 0);
...
static void dominterop_secp_v0_10_0_scalar_reduce_512(dominterop_secp_v0_10_0_scalar *r, const uint32_t *l) {
    uint64_t c;
...
static void dominterop_secp_v0_10_0_scalar_mul_512(uint32_t *l, const dominterop_secp_v0_10_0_scalar *a, const dominterop_secp_v0_10_0_scalar *b) {
    /* 96 bit accumulator. */
...
static void dominterop_secp_v0_10_0_scalar_sqr_512(uint32_t *l, const dominterop_secp_v0_10_0_scalar *a) {
    /* 96 bit accumulator. */
    uint32_t c0 = 0, c1 = 0, c2 = 0;
...
SECP256K1_INLINE static void dominterop_secp_v0_10_0_scalar_mul_shift_var(dominterop_secp_v0_10_0_scalar *r, const dominterop_secp_v0_10_0_scalar *a, const dominterop_secp_v0_10_0_scalar *b, unsigned int shift) {
    ...
    dominterop_secp_v0_10_0_scalar_cadd_bit(r, 0, (l[(shift - 1) >> 5] >> ((shift - 1) & 0x1f)) & 1);
...
static void dominterop_secp_v0_10_0_scalar_from_signed30(dominterop_secp_v0_10_0_scalar *r, const dominterop_secp_v0_10_0_modinv32_signed30 *a) {
...
static void dominterop_secp_v0_10_0_scalar_to_signed30(dominterop_secp_v0_10_0_modinv32_signed30 *r, const dominterop_secp_v0_10_0_scalar *a) {
...
static const dominterop_secp_v0_10_0_modinv32_modinfo dominterop_secp_v0_10_0_const_modinfo_scalar = {
...
static void dominterop_secp_v0_10_0_scalar_inverse(dominterop_secp_v0_10_0_scalar *r, const dominterop_secp_v0_10_0_scalar *x) {
    ...
    dominterop_secp_v0_10_0_scalar_to_signed30(&s, x);
    dominterop_secp_v0_10_0_modinv32(&s, &dominterop_secp_v0_10_0_const_modinfo_scalar);
    dominterop_secp_v0_10_0_scalar_from_signed30(r, &s);
...
static void dominterop_secp_v0_10_0_scalar_inverse_var(dominterop_secp_v0_10_0_scalar *r, const dominterop_secp_v0_10_0_scalar *x) {
    ...
    dominterop_secp_v0_10_0_scalar_to_signed30(&s, x);
    dominterop_secp_v0_10_0_modinv32_var(&s, &dominterop_secp_v0_10_0_const_modinfo_scalar);
    dominterop_secp_v0_10_0_scalar_from_signed30(r, &s);
