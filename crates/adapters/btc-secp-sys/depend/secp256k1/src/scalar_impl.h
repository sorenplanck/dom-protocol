...
static const dominterop_secp_v0_10_0_scalar dominterop_secp_v0_10_0_scalar_one = SECP256K1_SCALAR_CONST(0, 0, 0, 0, 0, 0, 0, 1);
static const dominterop_secp_v0_10_0_scalar dominterop_secp_v0_10_0_scalar_zero = SECP256K1_SCALAR_CONST(0, 0, 0, 0, 0, 0, 0, 0);

static int dominterop_secp_v0_10_0_scalar_set_b32_seckey(dominterop_secp_v0_10_0_scalar *r, const unsigned char *bin) {
    int overflow;
    dominterop_secp_v0_10_0_scalar_set_b32(r, bin, &overflow);

    SECP256K1_SCALAR_VERIFY(r);
    return (!overflow) & (!dominterop_secp_v0_10_0_scalar_is_zero(r));
}

static void dominterop_secp_v0_10_0_scalar_verify(const dominterop_secp_v0_10_0_scalar *r) {
    VERIFY_CHECK(dominterop_secp_v0_10_0_scalar_check_overflow(r) == 0);
 ...
 * lambda is: */
static const dominterop_secp_v0_10_0_scalar dominterop_secp_v0_10_0_const_lambda = SECP256K1_SCALAR_CONST(
    0x5363AD4CUL, 0xC05C30E0UL, 0xA5261C02UL, 0x8812645AUL,
    0x122E22EAUL, 0x20816678UL, 0xDF02967CUL, 0x1B23BD72UL
);

#ifdef VERIFY
static void dominterop_secp_v0_10_0_scalar_split_lambda_verify(const dominterop_secp_v0_10_0_scalar *r1, const dominterop_secp_v0_10_0_scalar *r2, const dominterop_secp_v0_10_0_scalar *k);
#endif
 ...
 */
static void dominterop_secp_v0_10_0_scalar_split_lambda(dominterop_secp_v0_10_0_scalar * SECP256K1_RESTRICT r1, dominterop_secp_v0_10_0_scalar * SECP256K1_RESTRICT r2, const dominterop_secp_v0_10_0_scalar * SECP256K1_RESTRICT k) {
    dominterop_secp_v0_10_0_scalar c1, c2;
    static const dominterop_secp_v0_10_0_scalar minus_b1 = SECP256K1_SCALAR_CONST(
        0x00000000UL, 0x00000000UL, 0x00000000UL, 0x00000000UL,
        0xE4437ED6UL, 0x010E8828UL, 0x6F547FA9UL, 0x0ABFE4C3UL
    );
    static const dominterop_secp_v0_10_0_scalar minus_b2 = SECP256K1_SCALAR_CONST(
        0xFFFFFFFFUL, 0xFFFFFFFFUL, 0xFFFFFFFFUL, 0xFFFFFFFEUL,
        0x8A280AC5UL, 0x0774346DUL, 0xD765CDA8UL, 0x3DB1562CUL
    );
    static const dominterop_secp_v0_10_0_scalar g1 = SECP256K1_SCALAR_CONST(
        0x3086D221UL, 0xA7D46BCDUL, 0xE86C90E4UL, 0x9284EB15UL,
        0x3DAA8A14UL, 0x71E8CA7FUL, 0xE893209AUL, 0x45DBB031UL
    );
    static const dominterop_secp_v0_10_0_scalar g2 = SECP256K1_SCALAR_CONST(
    ...
    dominterop_secp_v0_10_0_scalar_mul_shift_var(&c1, k, &g1, 384);
    dominterop_secp_v0_10_0_scalar_mul_shift_var(&c2, k, &g2, 384);
    dominterop_secp_v0_10_0_scalar_mul(&c1, &c1, &minus_b1);
    dominterop_secp_v0_10_0_scalar_mul(&c2, &c2, &minus_b2);
    dominterop_secp_v0_10_0_scalar_add(r2, &c1, &c2);
    dominterop_secp_v0_10_0_scalar_mul(r1, r2, &dominterop_secp_v0_10_0_const_lambda);
    dominterop_secp_v0_10_0_scalar_negate(r1, r1);
    dominterop_secp_v0_10_0_scalar_add(r1, r1, k);

    SECP256K1_SCALAR_VERIFY(r1);
    SECP256K1_SCALAR_VERIFY(r2);
#ifdef VERIFY
    dominterop_secp_v0_10_0_scalar_split_lambda_verify(r1, r2, k);
#endif
}

#ifdef VERIFY
/*
 * Proof for dominterop_secp_v0_10_0_scalar_split_lambda's bounds.
 *
 * Let
...
static void dominterop_secp_v0_10_0_scalar_split_lambda_verify(const dominterop_secp_v0_10_0_scalar *r1, const dominterop_secp_v0_10_0_scalar *r2, const dominterop_secp_v0_10_0_scalar *k) {
    ...
    dominterop_secp_v0_10_0_scalar_mul(&s, &dominterop_secp_v0_10_0_const_lambda, r2);
    dominterop_secp_v0_10_0_scalar_add(&s, &s, r1);
    VERIFY_CHECK(dominterop_secp_v0_10_0_scalar_eq(&s, k));

    dominterop_secp_v0_10_0_scalar_negate(&s, r1);
    dominterop_secp_v0_10_0_scalar_get_b32(buf1, r1);
    dominterop_secp_v0_10_0_scalar_get_b32(buf2, &s);
    VERIFY_CHECK(dominterop_secp_v0_10_0_memcmp_var(buf1, k1_bound, 32) < 0 || dominterop_secp_v0_10_0_memcmp_var(buf2, k1_bound, 32) < 0);

    dominterop_secp_v0_10_0_scalar_negate(&s, r2);
    dominterop_secp_v0_10_0_scalar_get_b32(buf1, r2);
    dominterop_secp_v0_10_0_scalar_get_b32(buf2, &s);
    VERIFY_CHECK(dominterop_secp_v0_10_0_memcmp_var(buf1, k2_bound, 32) < 0 || dominterop_secp_v0_10_0_memcmp_var(buf2, k2_bound, 32) < 0);
}
#endif /* VERIFY */
