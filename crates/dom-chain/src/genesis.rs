...
use dom_core::{
    BlockHeight, DomError, Hash256, BLOCK_VERSION_LEGACY, GENESIS_MESSAGE, GENESIS_NONCE_MAINNET,
    GENESIS_NONCE_REGTEST, GENESIS_POW_DIGEST_MAINNET, GENESIS_POW_DIGEST_REGTEST,
