...
use dom_rpc::{
    ...
    MempoolTxInfo, NodeHandle, PeerInfo, RpcError, ShutdownFuture, TxAdmission,
    TxAdmissionState, UtxoInfo, MAX_ANCESTRY_STEPS, MAX_SCAN_RANGE,
};
...
mod tests {
    ...
    use dom_rpc::{AncestryRequest, RpcError, SpendRequest, TxAdmissionState};
    use dom_serialization::{DomDeserialize, DomSerialize};
