//! dom-shield — FIX-026: cross-chain backup import guard.
//!
//! `import_backup` must bind backup payloads to the destination wallet's
...
//! chain, and assert the import is rejected before any output is injected.
