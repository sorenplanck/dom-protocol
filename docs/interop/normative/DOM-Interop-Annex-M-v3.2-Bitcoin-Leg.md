> **SUPERSEDED by Annex M v3.3 (2026-08-12). Historical text follows.**
>
> **Reconciliation note (v3.2)**
>
> **Status:** adopted as the F5 EXECUTION SPECIFICATION by operator order
> recorded in the project chat (2026-08-10, decision D-012 of the Foundation
> Document). This adoption authorizes implementation in the build order of
> M.17; it does NOT ratify D-013/D-014, does not execute any conformance
> layer and does not move gate G-F5, exactly as M.0.3 requires.
>
> **v3.2 delta over the operator's Portuguese v3.1** (kept verbatim in the
> operator's records): (a) English translation per the project's English-only
> publication rule; (b) decision identifiers renumbered D-008 → D-013 and
> D-009 → D-014, because the Foundation Document consumed D-008..D-011 for
> other ratified decisions after this annex was written; (c) base-document
> reference: the annex names v0.2.1 as its declared base; per its own
> hierarchy rule M.0.1, the currently ratified Foundation Document (v0.6)
> prevails.

DOM Interop — Annex M v3.2
...
The Foundation Document v0.2.1 is the declared base of this annex. Later
local copies marked as drafts do not promote D-013, D-014, A8 or A9 by
inference. A later formally ratified version prevails and requires a new
revision of this annex, preserving the history.
...
```text
ANNEX M v3.2 ............................. [PROPOSAL] technically closed
A8a  Parity and canonical extraction ..... TECHNICALLY CORRECT
                                             normative awaits D-013
A8b  MuSig2 + TapTweak + witness ......... SPECIFIED
                                             not ratified nor executed
A9   Test network ........................ SPECIFIED
                                             normative awaits D-014
C1a/C1b/C2/C3/C4 ......................... SPECIFIED; not executed
F5 ....................................... NOT STARTED by this document
G-F5 ..................................... NOT EXECUTED / NOT PASS
...
• substitute for the D-013/D-014 ratification.
...
• tree: a single refund leaf in v3.2;
• leaf version: 0xc0;
...
serialization format. v3.2 forbids copying its raw bytes to disk.
...
M.13. Networks, environments and D-014

M.13.1. Specified strategy

A9 is technically specified as follows:

1. regtest: deterministic tests, controlled mining, CSV maturity,
double-spend and injected reorg;
2. custom signet: a persistent controlled environment with a known challenge
and the operational capability for reorg scenarios;
3. public signet: external interoperability, real propagation, fees and
...
M.13.3. Future content of D-014

D-014 shall record, without self-ratification:
...
cargo test -p btc-adapter --features real-bitcoin-crypto,bitcoin-core-rpc,keystone-evidence --locked
cargo test -p btc-adapter --test c1a_bip327_official --locked
cargo test -p btc-adapter --test c1b_instrumented_hash --features instrumented-tagged-hash --locked
cargo test -p btc-adapter --test c2_adaptor_vectors --locked
cargo test -p btc-adapter --test c3_upstream_differential --locked
cargo test -p btc-adapter --test c4_adversarial --locked
cargo test -p btc-adapter --test crash_restore_process --locked
cargo test -p btc-adapter --test keystone_evidence --locked
cargo test -p f5-harness --locked
cargo clippy --workspace --all-targets --all-features --locked -- -D warnings
cargo test --workspace --doc --all-features --locked
cargo fuzz run fuzz_bitcoin_evidence_decode -- -runs=10000
cargo fuzz run fuzz_witness_parser -- -runs=10000
cargo xtask f5-regtest-e2e
cargo xtask f5-custom-signet-e2e
cargo xtask f5-public-signet-e2e
```

If the names do not yet exist in the workspace, F5 implements the targets or
documents a technically equivalent substitution. Silent omission is
forbidden.
...
Each environment executes, at a minimum:
...
In the cumulative set, every row is executed on regtest and custom signet.
Public signet executes at least E01–E06, E12–E14; deterministic reorg stays
on the custom signet. The report does not claim that public signet had an
injected reorg.
...
• the v3.2 text incorporated and D-013/D-014 formally ratified;
...
• regtest, custom signet and public signet executed;
...
M.16. D-013, ratification and governance
...
D-013  DATE TO BE SET  RATIFICATION PENDING
  ...
  Decision:      adopt Annex M v3.2 after C1a/C1b/C2/C3/C4 are green;
...
2. insert D-013 and D-014 with the applicable date, evidence and signature;
...
6. keep G-F5 NOT RUN until E2E execution;
7. only after M.15 declare PASS.
...
This Annex M v3.1 (superseded by this v3.2) is the integral and technically
...
```text
ANNEX M v3.2   = [PROPOSAL] TECHNICALLY CLOSED
A8a            = TECHNICALLY CORRECT; AWAITS D-013
A8b            = SPECIFIED; NOT RATIFIED; NOT EXECUTED
A9             = SPECIFIED; AWAITS D-014
F5             = NOT CONCLUDED BY THIS DOCUMENT
G-F5           = NOT EXECUTED / NOT PASS
```
