...
> **SUPERSEDED (2026-08-09).** Esta v0.2.1 foi substituída pela **v0.3** (`DOM-Interop-Documento-de-Fundacao-v0.3.md`) e saiu de circulação de agentes (§12.2). Mantida apenas como histórico; nenhuma seção aqui é autoridade de contexto.


```text
Versão:              0.2.1 (rascunho para ratificação)
Data:                2026-08-05
...
Substitui:           v0.2, v0.1 e o "KAYSTRA-USPE-KEYSTONE-DOCUMENTO-MESTRE v1.0.1"
...
```text
D-000  2026-08-05  RATIFICAÇÃO PENDENTE
...
D-001  2026-08-05  RATIFICAÇÃO PENDENTE
