...
> `DOM-Interop-Foundation-Document-v0.14.md` on 2026-08-11 (D-024: the
> one-time curative disposition for the F4 execution-order breach;
> G-F4 state recorded as MATERIAL EVIDENCE ACCEPTED — FORMAL
> ADJUDICATION PENDING §12.4–§12.6). It remains as history only and
...
State:               PARTIALLY RATIFIED — D-000, D-001, D-005, D-006, D-007,
                     ...
                     D-023 and A7 ratified; the rest remains
...
Product name:        DECIDED (D-009): no standalone product name. This is
                     ...
                     component name
Supersedes:          v0.12, v0.11, v0.10, v0.9, v0.8, v0.7, v0.6, v0.5, v0.4, v0.3, v0.2.1, v0.2, v0.1 and the
...
*This v0.13 supersedes v0.12, v0.11, v0.10, v0.9, v0.8, v0.7, v0.6, v0.5, v0.4, v0.3, v0.2.1, v0.2, v0.1 and the
