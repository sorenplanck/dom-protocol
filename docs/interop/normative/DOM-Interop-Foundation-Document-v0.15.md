...
> `DOM-Interop-Foundation-Document-v0.16.md`, which records D-026
> (G-F4 adjudicated PASS by the operator on 2026-08-11). Kept as
...
State:               PARTIALLY RATIFIED — D-000, D-001, D-005, D-006, D-007,
                     ...
                     D-023, D-024, D-025 and A7 ratified; the rest remains
...
Product name:        DECIDED (D-009): no standalone product name. This is
                     ...
                     component name
Supersedes:          v0.14, v0.13, v0.12, v0.11, v0.10, v0.9, v0.8, v0.7, v0.6, v0.5, v0.4, v0.3, v0.2.1, v0.2, v0.1 and the
...
Gate status:         G-F0 = PASS (docs/reports/F0-CLOSURE.md, waiver
                     ...
                     adjudication 2026-08-11; F3 = COMPLETED). G-F4 is
                     the first mandatory gate still open: implementation
                     and adversarial suites complete, material Sepolia
                     evidence accepted, but D-024 binds it to head
                     9c04d363 and protected paths have moved since — a
                     regression against the current head is required
                     before adjudication. F5 IN PROGRESS (D-012);
                     execution spec is Annex M v3.2; G-F5 NOT RUN
                     (M.15.2 public-signet leg outstanding). G-F6
                     EVIDENCE COMPLETE, adjudication deferred. G-F7
                     BLOCKED by external dependency. G-F8 NOT STARTED.
```
...
State (operator, 2026-08-11, D-024): G-F4 = MATERIAL EVIDENCE
ACCEPTED — FORMAL ADJUDICATION PENDING §12.4-§12.6. The Sepolia
evidence of run 31431363791 (HEAD 9c04d36) is accepted and is not to
be repeated out of generic doubt; the remaining run binds the gate to
the current head.
...
*This v0.15 supersedes v0.14, v0.13, v0.12, v0.11, v0.10, v0.9, v0.8, v0.7, v0.6, v0.5, v0.4, v0.3, v0.2.1, v0.2, v0.1 and the
...
ratified. The single change of this version over v0.14 is D-025: the
operator's adjudication of G-F3 = PASS and F3 = COMPLETED, with the gate
status header and §7 F3 updated to match. No other decision, invariant,
phase, open question or pin was altered.*
