...
> `DOM-Interop-Foundation-Document-v0.18.md`, which records D-028
> (G-F6 adjudicated PASS by the operator on 2026-08-12). Kept as
> history only and must not be used as context authority.
...
State:               PARTIALLY RATIFIED — D-000, D-001, D-005, D-006, D-007,
                     ...
                     D-023, D-024, D-025, D-026, D-027 and A7 ratified; the rest
...
Product name:        DECIDED (D-009): no standalone product name. This is
                     ...
                     component name
Supersedes:          v0.16, v0.15, v0.14, v0.13, v0.12, v0.11, v0.10, v0.9, v0.8, v0.7, v0.6, v0.5, v0.4, v0.3, v0.2.1, v0.2, v0.1 and the
...
Gate status:         G-F0 = PASS (docs/reports/F0-CLOSURE.md, waiver
                     ...
                     closed on regtest plus custom Signet only. G-F6
                     EVIDENCE COMPLETE, separate formal adjudication
                     pending now that G-F3, G-F4 and G-F5 are closed.
                     G-F7 BLOCKED by external
...
G-F4 are adjudicated and G-F5 passes (§8 ordering;
...
*This v0.17 supersedes v0.16, v0.15, v0.14, v0.13, v0.12, v0.11, v0.10, v0.9, v0.8, v0.7, v0.6, v0.5, v0.4, v0.3, v0.2.1, v0.2, v0.1 and the
...
ratified. The normative change over v0.16 is D-027: regtest plus custom
Signet BIP-325 are the complete F5 network requirement; Public Signet is
optional and cannot block F5-F8; mainnet remains excluded. D-014 is
preserved as SUPERSEDED history. No DOM or Bitcoin consensus primitive is
altered.*
