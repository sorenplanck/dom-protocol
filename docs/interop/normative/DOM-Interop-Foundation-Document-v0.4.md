> **SUPERSEDED (2026-08-10).** This version is no longer the context
> authority. The current authority is
> `DOM-Interop-Foundation-Document-v0.5.md` (adds D-009/D-010/D-011 and
> the G-F0 = PASS record R-002). Kept as history.
...
State:               PARTIALLY RATIFIED — D-000, D-001, D-005, D-006, D-007,
                     D-008 and A7 ratified (/goat order and operator
                     decisions of 2026-08-09/2026-08-10, recorded in
                     section 12); the rest remains DRAFT pending
                     ratification
Product name:        "DOM Interop" is a working name [PROPOSAL] — A1 kept
                     open by operator decision (2026-08-09)
Supersedes:          v0.3, v0.2.1, v0.2, v0.1 and the "KAYSTRA-USPE-
...
F1 status:           docs/reports/F1-CLOSURE.md (G-F1 = NOT_PASS; P0
                     blocker in §1.3 of that report)
```
...
```text
A1  Product name — OPEN by operator decision (2026-08-09):
    "DOM Interop" continues as the working name.
A2  Product license; Keystone relicensing/rewrite (BUSL) — OPEN;
    provisional measure ratified (D-007): proprietary for now
...
A12 Dyn-compat of the CounterpartyAdapter async trait (F0).
```
...
*This v0.4 supersedes v0.3, v0.2.1, v0.2, v0.1 and the
