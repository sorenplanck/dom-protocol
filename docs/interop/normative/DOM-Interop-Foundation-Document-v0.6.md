...
> **v0.7**, which carries the ratified decision **D-016** (DOM pin
> `a182563` → `eb6aa1c`). Kept as history only. The current authority is
> `DOM-Interop-Foundation-Document-v0.7.md`.
...
State:               PARTIALLY RATIFIED — D-000, D-001, D-005, D-006, D-007,
                     D-008, D-009, D-010, D-011, D-012 and A7 ratified;
                     D-013/D-014 RATIFICATION PENDING (F5 conformance
                     evidence); the rest remains DRAFT (/goat order and
                     operator decisions of 2026-08-09/10, recorded in
                     section 12)
Product name:        DECIDED (D-009): no standalone product name. This is
                     ...
                     component name
Supersedes:          v0.5, v0.4, v0.3, v0.2.1, v0.2, v0.1 and the "KAYSTRA-USPE-
...
*This v0.6 supersedes v0.5, v0.4, v0.3, v0.2.1, v0.2, v0.1 and the
