...
> `DOM-Interop-Foundation-Document-v0.9.md` on 2026-08-10 (D-013/D-014/
> D-015 ratified). It remains as history only and must not be used as
> context authority.
...
State:               PARTIALLY RATIFIED — D-000, D-001, D-005, D-006, D-007,
                     D-008, D-009, D-010, D-011, D-012, D-016, D-017 and A7
...
Product name:        DECIDED (D-009): no standalone product name. This is
                     ...
                     component name
Supersedes:          v0.7, v0.6, v0.5, v0.4, v0.3, v0.2.1, v0.2, v0.1 and the
...
*This v0.8 supersedes v0.7, v0.6, v0.5, v0.4, v0.3, v0.2.1, v0.2, v0.1 and the
