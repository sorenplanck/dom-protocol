...
> `DOM-Interop-Foundation-Document-v0.10.md` on 2026-08-10 (D-018:
> A5/A10 ratified for F6). It remains as history only and must not be
...
State:               PARTIALLY RATIFIED — D-000, D-001, D-005, D-006, D-007,
                     ...
                     D-016, D-017 and A7 ratified; the rest remains DRAFT
                     (/goat order and operator decisions of 2026-08-09/10,
...
Product name:        DECIDED (D-009): no standalone product name. This is
                     ...
                     component name
Supersedes:          v0.8, v0.7, v0.6, v0.5, v0.4, v0.3, v0.2.1, v0.2, v0.1 and the
...
*This v0.9 supersedes v0.8, v0.7, v0.6, v0.5, v0.4, v0.3, v0.2.1, v0.2, v0.1 and the
