...
- **G1a:** criptografia pura, incluindo vetores, transcript, dois nonces, adaptação, extração e verificação real DOM.
- **G1b:** Nonce Vault, orçamento, journal, testemunha remota, restauração e resistência a rollback.

Produção exige G1a e G1b aprovados. Esta execução não aprova nenhum deles.
