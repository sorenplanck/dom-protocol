...
| Exposure permit boundary | ratified NAR-002 section 18.2; ADR-0020 | closed exposure kinds; exact 252-byte permit; exact outbound digest; one-shot reveal authorization | exact parser, truncation, unknown-kind, mismatch tests; persistent fuzz target | G1b durable issuance/conformance pending | implemented boundary; gate open |
