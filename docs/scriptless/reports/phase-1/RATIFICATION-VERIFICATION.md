...
For all four artifacts, Minisign reported:
...
The four signed contents retain the exact pre-signing review hashes. Their detached signatures are tracked separately in the normative/vector manifests. No official repository was modified, and no push, merge, release, publication, consensus change, wire change, DL2P import, or real-funds authorization occurred during verification.
