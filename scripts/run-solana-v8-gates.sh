...
cargo fmt --all -- --check
cargo test -p solana-escrow-wire -p solana-types -p solana-pda -p solana-route-secret -p solana-profile -p solana-setup-store -p solana-program-client -p solana-transaction-builder -p solana-rpc -p solana-rpc-pool -p solana-program-attestation -p solana-evidence -p solana-observer -p solana-observation-store -p solana-observer-pump -p solana-kaystra-records -p solana-kaystra-source -p solana-counterparty -p solana-delivery -p solana-delivery-sqlite -p solana-live -p solana-session-init -p solana-secret-store -p solana-kaystra-bridge -p solana-runtime-wiring -p f8-solana-model -p f8-solana-e2e
cargo clippy -p solana-escrow-wire -p solana-types -p solana-pda -p solana-route-secret -p solana-profile -p solana-setup-store -p solana-program-client -p solana-transaction-builder -p solana-rpc -p solana-rpc-pool -p solana-program-attestation -p solana-evidence -p solana-observer -p solana-observation-store -p solana-observer-pump -p solana-kaystra-records -p solana-kaystra-source -p solana-counterparty -p solana-delivery -p solana-delivery-sqlite -p solana-live -p solana-session-init -p solana-secret-store -p solana-kaystra-bridge -p solana-runtime-wiring -p f8-solana-model -p f8-solana-e2e --all-targets -- -D warnings
